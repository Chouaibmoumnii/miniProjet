...
import {BackOfficeMicroModule} from "./back-office-micro/back-office-micro.module";
...
const routes: Routes = [
 ...
 // { path: 'back', loadChildren: () => import('./back-office/back-office.module').then(m => m.BackOfficeModule) },
  ...
  { path: 'back', loadChildren: () => import('./back-office-micro/back-office-micro.module').then(m => m.BackOfficeMicroModule) },
